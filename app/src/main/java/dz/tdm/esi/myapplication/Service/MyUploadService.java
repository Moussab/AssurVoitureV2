...
public class MyUploadService extends MyBaseTaskService {
    ...
    public static final String EXTRA_FILE_STORAGE = "EXTRA_FILE_STORAGE";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (ACTION_UPLOAD.equals(intent.getAction())) {
            ...
            StorageReference mStorageRef = intent.getParcelableExtra(EXTRA_FILE_STORAGE);
            uploadFromUri(fileUri,mStorageRef);
    ...
    private void uploadFromUri(final Uri fileUri, StorageReference mStorageRef) {
